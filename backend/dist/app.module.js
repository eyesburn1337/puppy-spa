...
const puppy_controller_1 = require("./interface/controllers/puppy.controller");
...
AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            nestjs_1.MikroOrmModule.forFeature([puppy_entity_1.Puppy, waiting_list_entity_1.WaitingList])
        ],
